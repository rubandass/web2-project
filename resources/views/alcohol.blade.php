...
<div class="container">
    <div class="row">
        <form class="col-md-4 mt-1" action="{{url('/workouts/storeAlcohol')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <div class="form-group">
                ...
                <div class="form-row">
                    <input type="text" class="form-control col-md-6 ml-1" name="calorie" placeholder="Enter drink's calorie">
                    <select class="form-control col-md-5 ml-4" name="calorie_type" id="selectItem">
        ...
        <div class="col-md-7 mt-5 offset-md-1">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    @endphp
                    @foreach($items as $item)
                    @foreach($item->alcohols as $alcohol)
                    <tr>
                        <td>{{$slNo++}}</td>
                        <td>{{$item->name}}</td>
        ...
        <div class="modal-content">
            <form method="POST" action="{{url('/deleteItem')}}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <input class="form-control" type="hidden" name="item_id" />
                    <div>
                        <h6 id="noDelete">You can't delete this item <b><span class="spanItemName"></span></b>. It has reference in alcohol table</h6>
